...
const WhoAreYouComponent = () => {

  const { t } = useTranslationContext();

  const points = [
    "An enthusiast interested in our app.",
    "Someone curious about technology.",
    "A user, investor, or partner seeking collaboration."
  ];

  return (
        <div className="p-6 bg-white shadow-lg border-2 border-red-500 rounded-lg">
          <h3 className="text-lg font-bold text-black mb-2"><u>{t('whoAreYou')}</u></h3>
...
export default WhoAreYouComponent