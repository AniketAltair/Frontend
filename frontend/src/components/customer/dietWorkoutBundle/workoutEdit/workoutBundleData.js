...
import FilterMuscleModal from '../../../services/workouts/createWorkoutBundles/filterMuscleModal';
import SelectedExerciseDetails from '../../../services/workouts/createWorkoutBundles/selectedExerciseDetails';
import { FaFilter, FaListAlt } from 'react-icons/fa';
import { MdCancel } from 'react-icons/md';
import SearchExercisesComponent from '../../../services/workouts/createWorkoutBundles/searchExercisesComponent';

const WorkoutBundleData = () => {
  ...
  const initialExercisesData = [
    ...
    const handleNavigateBackToMyWorkoutBundle = () => {
     ...
     const handleUpdateNewExercises = (searchValue, filterValue) => {
          ...
          const handleUpdateBundle = () => {
            ...
            handleNavigateBackToMyWorkoutBundle();
          };
        ...
        useEffect(()=>{
            ...
            setBundleName(currentBundleData.workout.name);
            setSelectedExercises(currentBundleData.workout.selectedExercises);
        },[]);
  ...
  return (
    <div className="font-cursive bg-white p-2 rounded-md">
        <div className="flex-col items-center">
            <button
              onClick={() => handleNavigateBackToMyWorkoutBundle()}
              className="mb-2 border-2 border-black flex items-center justify-center text-red-500 bg-white hover:bg-red-200 rounded-md w-6 h-6 shadow-lg transition duration-200"
            >
...
export default WorkoutBundleData;
