...
const TransactionHistoryComponent = () => {
  ...
  const transactionHistoryData = [
    { id: 1, planName: "Short Plan", paymentMethod: "PhonePe", amount: "100", transactionNumber: "zadkbekb13114sbcdsfdwfefefw", timestamp: "20-12-2025 15:00:00"},
    { id: 2, planName: "Long Plan", paymentMethod: "GooglePay", amount: "1000", transactionNumber: "zadkbekb131dfdcdsfdwfefefw", timestamp: "20-12-2024 16:00:00"},
    { id: 1, planName: "Short Plan", paymentMethod: "PhonePe", amount: "100", transactionNumber: "dddddqdgeghhhrhthrhrhrhrh", timestamp: "20-11-2024 17:00:00"},
    ...Array(35)
      .fill()
      .map((_, index) => ({
        id: index + 4,
  ...
  return (
    ...
    >
    <div className="font-cursive p-4 bg-white min-h-screen">
      <button
        onClick={() => navigate(-1)}
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Transaction History Data User Side</h2>
